...
if __name__ == "__main__":
      ...
      ssh_password = os.environ["MONITOR_SSH_PASSWORD"]
      time1 = get_remote_time(
            os.environ.get("MONITOR_HOST_A", "host-a.example.internal"),
            22,
            os.environ.get("MONITOR_USER_A", "monitor"),
            password=ssh_password,
      )

      time2 = get_remote_time(
            os.environ.get("MONITOR_HOST_B", "host-b.example.internal"),
            22,
            os.environ.get("MONITOR_USER_B", "monitor"),
            password=ssh_password,
      )
      ...
      resp = requests.post(
            os.environ.get(
                "PUSHGATEWAY_URL",
                "http://pushgateway.example.internal:9091/metrics/job/time_difference",
            ),
             data=data,
